...
export const DEFAULT_PRICE_TABLE: PriceEntry[] = [
  ...
  // before relying on this for a real bill).
  { id: 'claude-fable-5-1', matchModel: 'claude-fable-5-1', provider: 'anthropic', inputPerMTok: 10.0, outputPerMTok: 50.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-fable-5', matchModel: 'claude-fable-5', provider: 'anthropic', inputPerMTok: 10.0, outputPerMTok: 50.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-opus-5-5', matchModel: 'claude-opus-5-5', provider: 'anthropic', inputPerMTok: 4.0, outputPerMTok: 20.0, cacheReadPerMTok: 0.4, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-opus-5', matchModel: 'claude-opus-5', provider: 'anthropic', inputPerMTok: 5.0, outputPerMTok: 25.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-opus-4-8', matchModel: 'claude-opus-4-8', provider: 'anthropic', inputPerMTok: 5.0, outputPerMTok: 25.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-opus-4-7', matchModel: 'claude-opus-4-7', provider: 'anthropic', inputPerMTok: 5.0, outputPerMTok: 25.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-opus-4-6', matchModel: 'claude-opus-4-6', provider: 'anthropic', inputPerMTok: 5.0, outputPerMTok: 25.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-sonnet-5', matchModel: 'claude-sonnet-5', provider: 'anthropic', inputPerMTok: 2.0, outputPerMTok: 10.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-sonnet-4-6', matchModel: 'claude-sonnet-4-6', provider: 'anthropic', inputPerMTok: 3.0, outputPerMTok: 15.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
  { id: 'claude-haiku-4-5', matchModel: 'claude-haiku-4-5', provider: 'anthropic', inputPerMTok: 1.0, outputPerMTok: 5.0, sourceUrl: 'https://www.anthropic.com/pricing', sourceDate: '2026-06-24' },
