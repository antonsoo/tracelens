...
// examples/ and are used by otlp-parser.test.ts / normalize.test.ts /
// summary.test.ts instead of these — these are only for shapes real traces
// don't normally have (missing parents, clock skew, huge span counts).
